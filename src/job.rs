...
pub(crate) struct CmdArgs {
    ...
    pub(crate) thread_count: u16,

    /// Options you want to pass to ffmpeg. For the output file name, use --output
    #[arg(short, long, allow_hyphen_values = true)]
    pub(crate) ffmpeg_options: Option<String>,

    /// The files you want to process.
    #[arg(short, long, num_args = 1.., required_unless_present = "file_list", conflicts_with = "file_list", required_unless_present = "gui", conflicts_with = "gui")]
    ...
    pub(crate) file_list: Option<String>,
    ...
    #[arg(short, long, required_unless_present = "gui", conflicts_with = "gui")]
    ...
    /// Starts ffzap in GUI mode, ignoring all other cmd flags
    #[arg(long, default_value_t = false)]
    pub(crate) gui: bool,
}

pub(crate) fn run_job(cmd_args: CmdArgs) {
    if cmd_args.eta {
